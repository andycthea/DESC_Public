...
obj_curr_scale = ObjectiveFromUser(obj_curr, eq_step, target=0., weight=0.1)
...
eq_step_opt.save("data/eq_step_opt3.h5")
eq_step_vac_opt.save("data/eq_step_vac_opt3.h5")

with open("data/result3.pickle", "wb") as f:
